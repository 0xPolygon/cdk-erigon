...
# Variables
dataPath="./datadir"
firstStop=2466 # batch 100
# secondStop=4061 # batch 150
secondStop=55724 # batch 1000
# secondStop=2592 # batch 103
unwindBatch=100
logFile="script.log"
...
different_files=(
    ...
    "CallToIndex.txt"
    "DbInfo.txt"
    # "HermezSmtIntermediateHashes.txt"
)
