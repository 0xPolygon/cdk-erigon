...
func SpawnL1InfoTreeStage(
	...
	processedLogs, err := cfg.updater.WarmUp(logPrefix, tx)
...
func UnwindL1InfoTreeStage(u *stagedsync.UnwindState, tx kv.RwTx, cfg L1CombinedSyncerCfg, ctx context.Context) error {
	return nil
}

func PruneL1InfoTreeStage(s *stagedsync.PruneState, tx kv.RwTx, cfg L1CombinedSyncerCfg, ctx context.Context) error {
	return nil
}
