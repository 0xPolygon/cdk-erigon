...
func main() {
	...
	client1 := client.NewStreamClient(ctx, stream1, false, 0, 0, client.DefaultEntryChannelSize)
	client2 := client.NewStreamClient(ctx, stream2, false, 0, 0, client.DefaultEntryChannelSize)
