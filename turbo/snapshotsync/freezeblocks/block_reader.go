...
// Dummy function to satisfy zk block reader interface
func (r *BlockReader) TxnEffectiveGasPricePercentage(ctx context.Context, tx kv.Tx, txnHash libcommon.Hash) (uint8, error) {
	return 0, nil
}
