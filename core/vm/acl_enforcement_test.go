...
func TestACL_TopLevel_AllowAndDeny(t *testing.T) {
	...
	// Enable ACL
	b.SetVMConfig(vm.Config{ACLEnabled: true, ACLAddress: allowAddr})
	...
	b.SetVMConfig(vm.Config{ACLEnabled: true, ACLAddress: denyAddr})
...
func TestACL_NestedCall_Deny(t *testing.T) {
	...
	b.SetVMConfig(vm.Config{ACLEnabled: true, ACLAddress: aclAddr})
