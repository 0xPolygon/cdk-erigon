...
import (
	...
	"github.com/erigontech/erigon/cmd/ci/helpers"
...
func run(cliCtx *cli.Context) error {
	...
	c, err := helpers.CompileContract("cmd/ci/contracts/selfdestruct.sol")
	if err != nil {
	...
	abiFile, err := os.Open("cmd/ci/abi/SelfDestruct.abi")
	if err != nil {
		return err
	}
	defer abiFile.Close()
